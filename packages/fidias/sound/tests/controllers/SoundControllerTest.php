...
class SoundControllerTest extends TestCase
{
    ...
    {
        $response = $this->call('GET', '/sound/create');
    ...
    {
        $json_schema_file = storage_path("app/json-schema/sound.json");
        $contents = file_get_contents($json_schema_file);
        $json_schema_example = storage_path("app/json-schema/sound-example.json");
