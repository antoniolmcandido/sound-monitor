...
define(['jquery', 'moment', 'Chart', 'monitors/timeout', 'monitors/monitor'],
    function ($, moment, Chart, TIMEOUT, model) {
        ...
        var Sound = function(template, monitor) {
        ...
        Sound.prototype.render = function (items) {
            items = items || [];
        ...
        Sound.prototype.plot = function (items) {
            items = items || [];
            var labels = [];
            var serie = [];
            var len = items.length;
        ...
        $.when(
            $.get('/templates/sound/show.mustache'),
            ...
            var obj = new Sound(template, monitor);
            obj.render(items);
            obj.plot(items);
